...
direction_prop = 1.0  # 1 pour les variateurs à droite ou un petit rapport correspond à une marche avant
pwm_stop_prop = 1.0
point_mort_prop = 1.0
delta_pwm_max_prop = 1.0  # pwm à laquelle on atteint la vitesse maximale

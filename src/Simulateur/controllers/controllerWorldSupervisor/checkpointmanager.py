...
# 2. On définit la Piste 1 (Circuit complexe)
track_1 = [
...
# 3. Construction de la liste finale pour le Superviseur
# Index 0 : Piste 0 (Sens Normal)
# Index 1 : Piste 1 (Sens Normal)
# Index 2 : Piste 0 (Sens Inverse)
# Index 3 : Piste 1 (Sens Inverse)
checkpoints = [
    track_0,
    track_1,
    create_reverse_track(track_0),
    create_reverse_track(track_1)
]
